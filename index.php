    ...
    <div class="page-holder">
          ...
          <nav class="navbar navbar-expand-lg navbar-light py-3 px-lg-0"><a class="navbar-brand" href="index.php"><span class="font-weight-bold text-uppercase text-dark">Boutique</span></a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav mr-auto">
                <li class="nav-item">
                  <!-- Link--><a class="nav-link active" href="index.php?action=all">Home</a>
                </li>
                <li class="nav-item">
      ...
      <div class="container">
          ...
          <div class="container py-5">
            <div class="row px-4 px-lg-5">
              <div class="col-lg-6">
                ...
                <h1 class="h2 text-uppercase mb-3">20% off on new season</h1><a class="btn btn-dark" href="shop.php?action=all">Browse collections</a>
              </div>
            </div>
          </div>
        </section>
        ...
        <section class="pt-5">
          ...
          <div class="row">
            <div class="col-md-4 mb-4 mb-md-0"><a class="category-item" href="shop.php?action=clothes"><img class="img-fluid" src="img/cat-img-1.jpg" alt=""><strong class="category-item-title">Clothes</strong></a></div>
            <div class="col-md-4 mb-4 mb-md-0"><a class="category-item mb-4" href="shop.php?action=mobiles"><img class="img-fluid" src="img/R.png" alt=""><strong class="category-item-title">mobiles</strong></a><a class="category-item" href="shop.php?action=watches"><img class="img-fluid" src="img/cat-img-3.jpg" alt=""><strong class="category-item-title">Watches</strong></a></div>
            <div class="col-md-4"><a class="category-item" href="shop.php?action=laptops"><img class="img-fluid" src="img/hp-pavilion.jpg" alt=""><strong class="category-item-title">laptops</strong></a></div>
          </div>
        </section>
        <!-- TRENDING PRODUCTS-->
        <section class="py-5">
          ...
          $sel_products = " SELECT * FROM products ORDER BY RAND() LIMIT 4 " ;
