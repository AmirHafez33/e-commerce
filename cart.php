...
// if(!isset($_GET['id'])){
//   header("location:shop.php?action=all");
// }
...
$total_price = 0 ;
// if(isset($_GET['qnt'])){
//   $_SESSION['qnt'] = $_GET['qnt'];
//   header("location:admin/database/update_cart.php");
// }
// ?>
            ...
            <div class="col-lg-8 mb-4 mb-lg-0">
                ...
                <table class="table">
                  ...
                  <?php
                    foreach($query_cart as $cart){
                      ...
                      $sel_pro_img = "SELECT * FROM images WHERE pro_id = $pro_id";
                      $query_pro_img = $conn->query($sel_pro_img);
                      $image = $query_pro_img->fetch_assoc();
                  ?>
                    
                      <tr>
                      <th class="pl-0 border-0" scope="row">
                        <div class="media align-items-center"><a class="reset-anchor d-block animsition-link" href="detail.php?id=<?= $product['id'] ?>"><img src="admin/images/<?= $image['name'] ?>" alt="..." width="70"/></a>
                      ...
                      <td class="align-middle border-0">
                        <p class="mb-0 small">$<?= $product['price'] * $cart['quantity'] ?></p>
                      </td>
                      <td class="align-middle border-0"><a class="reset-anchor" href="admin/database/delete_cart.php?pro_id=<?= $product['id'] ?>"><i class="fas fa-trash-alt small text-muted"></i></a></td>
                    </tr>
                      <?php
              ...
              <div class="bg-light px-4 py-3">
                <div class="row align-items-center text-center">
                  <div class="col-md-6 mb-3 mb-md-0 text-md-left"><a class="btn btn-link p-0 text-dark btn-sm" href="shop.php?action=all"><i class="fas fa-long-arrow-alt-left mr-2"> </i>Continue shopping</a></div>
              ...
              <div class="card border-0 rounded-0 p-lg-4 bg-light">
                <div class="card-body">
                  ...
                  <ul class="list-unstyled mb-0">
                    <li class="d-flex align-items-center justify-content-between"><strong class="text-uppercase small font-weight-bold">Subtotal</strong><span class="text-muted small">$<?= $total_price/2 ?></span></li>
